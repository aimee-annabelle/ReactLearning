...
export default function Card() {
  return (
    <div className="w-2/5 h-[100vh] py-11 px-28 bg-zinc-800 flex justify-center">
      <div className="relative h-full w-9/12 bg-[#1a1b21] rounded-xl text-white text-center">
        <img
          src={image}
          alt=""
        ...
        <About />
        <div className="bg-neutral-900 w-full absolute bottom-0 rounded-b-xl px-8">
          <Footer />
        </div>
      </div>
    </div>
